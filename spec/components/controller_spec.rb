...
RSpec.describe Components::Controller do
  ...
  describe "#index" do
    it "returns the list of components" do
      allow(Db::Records::Component).to receive(:all).and_return([{"id" => 1, "bike_id" => 1, "name" => "Component 1", "description" => "Description 1"}])
  ...
  describe "#create" do
    it "creates a new component" do
      allow(Db::Records::Component).to receive(:create).and_return([{id: 1, name: "New Component", description: "New Description"}])
      ...
      expect(Db::Records::Component).to have_received(:create).with({bike_id: 1, name: "New Component", description: "New Description"})
    end
  end

  describe "#read" do
    it "returns the component with the given id if it exists" do
      allow(Db::Records::Component).to receive(:find_by).and_return({"id" => 1, "bike_id" => 1, "name" => "Component 1", "description" => "Description 1"})
    ...
    it "returns 404 Not Found if the component does not exist" do
      allow(Db::Records::Component).to receive(:find_by).and_return(nil)
  ...
  describe "#update" do
    it "updates the component with the given id if it exists" do
      ...
      allow(Db::Records::Component).to receive(:find_by).and_return(component)
